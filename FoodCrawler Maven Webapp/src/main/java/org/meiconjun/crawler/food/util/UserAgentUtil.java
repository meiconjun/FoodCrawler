...
/**
 * 从已有列表中随机返回user-agent
 * @author meiconjun
 * @time 2019年4月6日下午4:49:03
 */
public class UserAgentUtil {
	private static ArrayList<String> userAgentList = new ArrayList<String>();
	//类加载时初始化useragent列表
	static {
		userAgentList.add("Mozilla/5.0 (Windows NT 10.0; WOW64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/68.0.3440.106 Safari/537.36");
	 ...
	 * 获取一个随机useragent
	 * @author meiconjun
	 * @time 2019年4月6日下午4:58:37
	 */
	public static String getRandomUserAgent() {
		return userAgentList.get(new SecureRandom().nextInt(userAgentList.size()));
	}
}
